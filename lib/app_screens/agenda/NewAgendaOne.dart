...
class _NewAgendaOneState extends State<NewAgendaOne> {
...
//  AuthStatus _authStatus = AuthStatus.notSignedIn;
  ...
  Future <List<ConferenceAgenda>> _getTuesdayAgenda() async
  {
...
//    print(date);
    ...
    List <ConferenceAgenda> tuesAgenda = [];
...
//          String formatedDate = DateFormat('EEEE, MMM d, ''yyyy').format(dated);
          ...
          if (day == '3') {
            ...
            tuesAgenda.add(conferenceAgenda);
          }
  ...
  void dispose() {
    ...
    Widget build(BuildContext context) {
      ...
      return SingleChildScrollView(
        ...
        child: new Text('Tuesday, 3rd September 2019',
          style: new TextStyle(
              color: Colors.white,
              fontSize: 17.0,
