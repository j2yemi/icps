                          ...
                          child: new Align(
                            ...
                            child: new Column(
                              children: <Widget>[
                                Divider(),
                                new Container(
                                  padding: new EdgeInsets.only(left: 45.0, top: 10.0, bottom: 10.0),
                                  child: new Row(
                                    children: <Widget>[
                                      new Container(
                                        child: new Text('Technology: ',
                                ...
                                new Container(
                                  padding: new EdgeInsets.only(left: 44.0, bottom: 10.0),
                                  child: new Row(
                                    children: <Widget>[
                                      new Container(
                                        child: new Text('Credits: ',
...
//                ),
                ...
                new Container(
                  child: Text("Powered by Central Bank of Nigeria",
