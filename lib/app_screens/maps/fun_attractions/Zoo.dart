...
class _ZooState extends State<Zoo>
{
  ...
  // final LatLng _center = const LatLng(9.0887213, 7.5137013);

  static final CameraPosition _kGooglePlex = CameraPosition(
    target: LatLng(9.0887213, 7.5137013),
    zoom: 18.0,
  );
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: new AppBar(
        ...
        title: new Text("National Childrens\' Park and Zoo "),
        leading: Builder(
