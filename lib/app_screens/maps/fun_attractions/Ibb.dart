...
class Ibb extends StatefulWidget {

  Data data; String password;

  Ibb({this.data, this.password});

  @override
  _IbbState createState() => _IbbState();
}
...
class _IbbState extends State<Ibb>
{
  GoogleMapController mapController;

  // final LatLng _center = const LatLng(9.0841337, 7.5114417);

  static final CameraPosition _kGooglePlex = CameraPosition(
    target: LatLng(9.0841337, 7.5114417),
    zoom: 18.0,
  );
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: new AppBar(
        ...
        title: new Text("IBB International Golf & Country Club"),
        leading: Builder(
