...
class Funville extends StatefulWidget {

  Data data; String password;

  Funville({this.data, this.password});

  @override
  _FunvilleState createState() => _FunvilleState();
}
...
class _FunvilleState extends State<Funville>
{
  GoogleMapController mapController;

 // final LatLng _center = const LatLng(9.0662447, 7.4886625);

  static final CameraPosition _kGooglePlex = CameraPosition(
    target: LatLng(9.0662447, 7.4886625),
    zoom: 18.0,
  );
