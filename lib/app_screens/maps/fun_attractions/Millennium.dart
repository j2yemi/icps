...
class Millennium extends StatefulWidget {

  Data data; String password;

  Millennium({this.data, this.password});

  @override
  _MillenniumState createState() => _MillenniumState();
}
...
class _MillenniumState extends State<Millennium>
{
  GoogleMapController mapController;

  // final LatLng _center = const LatLng(9.0253248, 7.47239);

  static final CameraPosition _kGooglePlex = CameraPosition(
    target: LatLng(9.0253248, 7.47239),
    zoom: 18.0,
  );
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: new AppBar(
        ...
        title: new Text("Millennium Park"),
        leading: Builder(
