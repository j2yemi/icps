...
class Jojo extends StatefulWidget {
  ...
  Jojo({this.data, this.password});

  @override
  _JojoState createState() => _JojoState();
}
...
class _JojoState extends State<Jojo>
{
  ...
  // final LatLng _center = const LatLng(9.0758953, 7.4389369);

  static final CameraPosition _kGooglePlex = CameraPosition(
    target: LatLng(9.0758953, 7.4389369),
    zoom: 18.0,
  );
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: new AppBar(
        ...
        title: new Text("Jojo\'s Fun Water Park"),
        leading: Builder(
