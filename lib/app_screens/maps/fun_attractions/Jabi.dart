...
class Jabi extends StatefulWidget {

  Data data; String password;

  Jabi({this.data, this.password});

  @override
  _JabiState createState() => _JabiState();
}
...
class _JabiState extends State<Jabi>
{
  GoogleMapController mapController;

  // final LatLng _center = const LatLng(9.0666126, 7.4143747);

  static final CameraPosition _kGooglePlex = CameraPosition(
    target: LatLng(9.0666126, 7.4143747),
    zoom: 18.0,
  );
