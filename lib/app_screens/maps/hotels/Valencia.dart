...
class Valencia extends StatefulWidget {

  Data data; String password;

  Valencia({this.data, this.password});

  @override
  _ValenciaState createState() => _ValenciaState();
}
...
class _ValenciaState extends State<Valencia>
{
  GoogleMapController mapController;

  // final LatLng _center = const LatLng(9.0715643, 7.4812389);

  static final CameraPosition _kGooglePlex = CameraPosition(
    target: LatLng(9.0715643, 7.4812389),
    zoom: 18.0,
  );
