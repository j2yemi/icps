...
class Ambassador extends StatefulWidget {
  ...
  Ambassador({this.data, this.password});

  @override
  _AmbassadorState createState() => _AmbassadorState();
}
...
class _AmbassadorState extends State<Ambassador>
{
  ...
  // final LatLng _center = const LatLng(9.067906, 7.4299206);

  static final CameraPosition _kGooglePlex = CameraPosition(
    target: LatLng(9.067906, 7.4299206),
    zoom: 18.0,
  );
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: new AppBar(
        ...
        title: new Text("Hotel Ambassador"),
        leading: Builder(
