...
class Serendib extends StatefulWidget {

  Data data; String password;

  Serendib({this.data, this.password});

  @override
  _SerendibState createState() => _SerendibState();
}
...
class _SerendibState extends State<Serendib>
{
  GoogleMapController mapController;

  // final LatLng _center = const LatLng(9.0730141, 7.4758895);

  static final CameraPosition _kGooglePlex = CameraPosition(
    target: LatLng(9.0730141, 7.4758895),
    zoom: 18.0,
  );
