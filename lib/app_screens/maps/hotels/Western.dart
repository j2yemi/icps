...
class Western extends StatefulWidget {
  ...
  Western({this.data, this.password});
...
class _WesternState extends State<Western>
{
  ...
  // final LatLng _center = const LatLng(9.0636594, 7.4138157);

  static final CameraPosition _kGooglePlex = CameraPosition(
    target: LatLng(9.0636594, 7.4138157),
    zoom: 18.0,
  );
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: new AppBar(
        ...
        title: new Text("Western Dreams Hotel"),
        leading: Builder(
