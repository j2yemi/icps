...
class Petrus extends StatefulWidget {

  Data data; String password;

  Petrus({this.data, this.password});

  @override
  _PetrusState createState() => _PetrusState();
}
...
class _PetrusState extends State<Petrus>
{
  GoogleMapController mapController;

  // final LatLng _center = const LatLng(9.0388465, 7.5065656);

  static final CameraPosition _kGooglePlex = CameraPosition(
    target: LatLng(9.0388465, 7.5065656),
    zoom: 18.0,
  );
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: new AppBar(
        ...
        title: new Text("Petrus Hotel Royale"),
        leading: Builder(
