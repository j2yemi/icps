...
class Elvis extends StatefulWidget {

  Data data; String password;

  Elvis({this.data, this.password});

  @override
  _ElvisState createState() => _ElvisState();
}
...
class _ElvisState extends State<Elvis>
{
  GoogleMapController mapController;

  // final LatLng _center = const LatLng(9.084948, 7.4739033);

  static final CameraPosition _kGooglePlex = CameraPosition(
    target: LatLng(99.084948, 7.4739033),
    zoom: 18.0,
  );
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: new AppBar(
        ...
        title: new Text("BON Hotel Elvis"),
        leading: Builder(
