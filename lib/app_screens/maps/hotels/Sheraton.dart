...
class Sheraton extends StatefulWidget {

  Data data; String password;

  Sheraton({this.data, this.password});

  @override
  _SheratonState createState() => _SheratonState();
}
...
class _SheratonState extends State<Sheraton>
{
  GoogleMapController mapController;

  // final LatLng _center = const LatLng(9.0638495, 7.4846541);

  static final CameraPosition _kGooglePlex = CameraPosition(
    target: LatLng(9.0636323, 7.4839808),
    zoom: 18.0,
  );
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: new AppBar(
        ...
        title: new Text("Sheraton Abuja Hotel"),
        leading: Builder(
