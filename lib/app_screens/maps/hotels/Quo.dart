...
class Quo extends StatefulWidget {
  ...
  Quo({this.data, this.password});

  @override
  _QuoState createState() => _QuoState();
}
...
class _QuoState extends State<Quo>
{
 ...
 // final LatLng _center = const LatLng(9.0809728, 7.4713538);

  static final CameraPosition _kGooglePlex = CameraPosition(
    target: LatLng(9.0809728, 7.4713538),
    zoom: 18.0,
  );
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: new AppBar(
        ...
        title: new Text("Quo Vadis Hotel"),
        leading: Builder(
