...
class _YabanState extends State<Yaban>
{
  GoogleMapController mapController;

  // final LatLng _center = const LatLng(9.0839483, 7.4660307);
  static final CameraPosition _kGooglePlex = CameraPosition(
    target: LatLng(9.0839483, 7.4660307),
    zoom: 18.0,
  );
