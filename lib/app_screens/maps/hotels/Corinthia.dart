...
class Corinthia extends StatefulWidget {

  Data data; String password;

  Corinthia({this.data, this.password});

  @override
  _CorinthiaState createState() => _CorinthiaState();
}
...
class _CorinthiaState extends State<Corinthia>
{
  GoogleMapController mapController;

  // final LatLng _center = const LatLng(9.0342527, 7.5035926);

  static final CameraPosition _kGooglePlex = CameraPosition(
    target: LatLng(9.0342527, 7.5035926),
    zoom: 18.0,
  );
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: new AppBar(
        ...
        title: new Text("Corinthia Villa Hotel"),
        leading: Builder(
