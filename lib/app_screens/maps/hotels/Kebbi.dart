...
class Kebbi extends StatefulWidget {

  Data data; String password;

  Kebbi({this.data, this.password});

  @override
  _KebbiState createState() => _KebbiState();
}
...
class _KebbiState extends State<Kebbi>
{
  GoogleMapController mapController;

  // final LatLng _center = const LatLng(9.0648672, 7.4934261);

  static final CameraPosition _kGooglePlex = CameraPosition(
    target: LatLng(9.0648672, 7.4934261),
    zoom: 18.0,
  );
