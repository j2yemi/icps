...
class Oak extends StatefulWidget {

  Data data; String password;

  Oak({this.data, this.password});

  @override
  _OakState createState() => _OakState();
}
...
class _OakState extends State<Oak>
{
  GoogleMapController mapController;

 // final LatLng _center = const LatLng(9.0918892, 7.4747694);

  static final CameraPosition _kGooglePlex = CameraPosition(
    target: LatLng(9.0918892, 7.4747694),
    zoom: 18.0,
  );
