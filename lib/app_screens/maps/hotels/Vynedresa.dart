...
class Vynedresa extends StatefulWidget {

  Data data; String password;

  Vynedresa({this.data, this.password});

  @override
  _VynedresaState createState() => _VynedresaState();
}
...
class _VynedresaState extends State<Vynedresa>
{
  GoogleMapController mapController;

  // final LatLng _center = const LatLng(9.0419766, 7.4968558);

  static final CameraPosition _kGooglePlex = CameraPosition(
    target: LatLng(9.0419766, 7.4968558),
    zoom: 18.0,
  );
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: new AppBar(
        ...
        title: new Text("Vynedresa Hotel"),
        leading: Builder(
