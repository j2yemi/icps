...
class Boardwalk extends StatefulWidget {
  ...
  Boardwalk({this.data, this.password});

  @override
  _BoardwalkState createState() => _BoardwalkState();
}
...
class _BoardwalkState extends State<Boardwalk>
{
  ...
  // final LatLng _center = const LatLng(9.0774611, 7.4811224);

  static final CameraPosition _kGooglePlex = CameraPosition(
    target: LatLng(9.0774611, 7.4811224),
    zoom: 18.0,
  );
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: new AppBar(
        ...
        title: new Text("Boardwalk Hotel"),
        leading: Builder(
