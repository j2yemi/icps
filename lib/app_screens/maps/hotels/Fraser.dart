...
class Fraser extends StatefulWidget {

  Data data; String password;

  Fraser({this.data, this.password});

  @override
  _FraserState createState() => _FraserState();
}
...
class _FraserState extends State<Fraser>
{
  GoogleMapController mapController;

  // final LatLng _center = const LatLng(9.0545096, 7.4776902);

  static final CameraPosition _kGooglePlex = CameraPosition(
    target: LatLng(9.0545096, 7.4776902),
    zoom: 18.0,
  );
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: new AppBar(
        ...
        title: new Text("Fraser Suites Abuja"),
        leading: Builder(
